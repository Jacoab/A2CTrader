...
state, reward, _ = env.step('BUY', 'AMZN', 1)
print('Step 1')
print('State: ', state)
print('Funds: $', env.get_funds())
print('Portfolio value: ', env.get_portfolio_val())
...
state, reward, _ = env.step('SELL', 'AMZN', 1)
print('Step 2')
print('State: ', state)
print('Funds: $', env.get_funds())
print('Portfolio value: ', env.get_portfolio_val())
...
state, reward, _ = env.step('BUY', 'NVDA', 1)
print('Step 3')
print('State: ', state)
print('Funds: $', env.get_funds())
print('Portfolio value: ', env.get_portfolio_val())
...
_, _, _ = env.step('SELL', 'NVDA', 1)
state, reward, done = env.step('SELL', 'NVDA', 1)
print('Is done?: ', done)
print()
